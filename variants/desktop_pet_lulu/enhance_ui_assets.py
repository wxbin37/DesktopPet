...
def build_hd_assets():
    ...
    resize_typing_scene(SOURCE_DIR / TYPING_REST_OVERLAY, HD_DIR / TYPING_REST_OVERLAY)
    resize_typing_scene(SOURCE_DIR / TYPING_TAP_OVERLAY, HD_DIR / TYPING_TAP_OVERLAY)
